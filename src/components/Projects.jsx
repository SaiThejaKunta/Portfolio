...
const Projects = () => {
    return (
        <div className="h-screen flex flex-col text-white relative">
                        ...
                        projectsdata.map((project) => {
                            return (
                                <div className="flex flex-col justify-center items-center snap-center mx-96" key={project.id}> 
                                    ...
                                    src={project.img} 
                                    alt={project.altname} 
                                    className="w-44 h-32 sm:w-72 sm:h-60 lg:w-[450px] lg:h-[400px]"
                                    ...
                                    <div className="flex">
                                        ...
                                        <a href={project.url} className="h-5 w-5 md:h-7 md:w-7 lg:h-9 lg:w-9 ml-5 mt-1 text-white" target="_blank">
            ...
            <motion.div className="flex-1 bottom-0 right-0 text-[40px] md:text-[150px] lg:text-[150px] absolute opacity-10 font-opensans">Projects</motion.div> 
        </div>
    )
}
